...
I am pursuing research in Bayesian statistics, machine learning, clustering models, and causal inference. Currently, my work focuses on Bayesian nonparametrics and its application in large-scale clustered data. 
